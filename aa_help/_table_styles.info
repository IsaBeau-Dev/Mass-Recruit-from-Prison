...
name_of_table_style = {
	...
	# What master ambiance will be played when this table style is selected.
	# Possible values are western, asian
	audio_parameter = western

	# Path to the environment this table style should switch to when showing the map table
